    ...
    <q-drawer v-model="drawerRight" side="right" :show-if-above="false" :width="200" :breakpoint="1000" elevated class="bg-primary text-white no-scroll">
      ...
      <q-scroll-area class="fit">
        <div class="contenido" v-show="drawerRight">
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/') }" to="/" flat>
            <span class="custom-overline">Inicio</span>
          </q-btn>
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/actividades') }" to="/actividades" flat>
            <span class="custom-overline">Actividades</span>
          </q-btn>
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/habitaciones') }" to="/habitaciones" flat>
            <span class="custom-overline">Habitaciones</span>
          </q-btn>
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/servicios') }" to="/servicios" flat>
            <span class="custom-overline">Servicios</span>
          </q-btn>
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/contacto') }" to="/contacto" flat>
            <span class="custom-overline">Contacto</span>
          </q-btn>
          <q-btn class="navegacion" :class="{  'my-active-class':  isActive('/reserva') }" to="/reserva" flat>
            <span class="custom-overline">Reserva</span>
          </q-btn>
        </div>
      </q-scroll-area>
